...
@Pipe({
  ...
  export class ReportName implements PipeTransform {
  
    transform(value: any): any {
      if (value == 1001 || value == '1001') {
        return "Social Category Wise Enrolment";
      }
      else if (value == 1002 || value == '1002') {
        return "School Category Management Wise Enrolment";
      }
      else if (value == 2 || value == '2') {
        return "Tribal Welfare Department"
