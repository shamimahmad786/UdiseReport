...
//anychart:any;
  ...
  constructor(private tabularDataService: TabularDataService,private routerService:Router){
...
//     var chart = anychart.sunburst(this.data, "as-tree");
...
getTabularData(mapId: any) {
  ...
  this.tabularDataService.getTabularData(mapId).subscribe((res) => {
    debugger
    console.log("res cvgfvngvjmhnb--->" + JSON.stringify(res.rowValue));
